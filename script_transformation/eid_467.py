...
def user_defined_export(graph_mgr, node_id, node_properties):
     try:
         ...
         if node_properties['additional_info_dict'] is None:
             weight = node_properties['additional_info_dict2'].get('Shipping Weight', '5kg').lower()
         else:
         ...
         if len(variants) == 0:
             ...
             result['option_names'] = ['size', 'color']
         ...
         for image in node_properties['detail_images']:
