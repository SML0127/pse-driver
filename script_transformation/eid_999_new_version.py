...
def user_defined_export(graph_mgr, node_id, node_properties):
     try:
         ...
         margin_rate = pricing_information["min_margin"]
         ...
         dollar2krw = pricing_information["dollar2krw"]
         ...
         tariffRate = tariff_rate if amount + delivery_charge/dollar2krw>= 200 else 0;
         taxRate = vat_rate if amount + delivery_charge/dollar2krw>= 200 else 0;
