...
def user_defined_export(graph_mgr, node_id, node_properties):
     try:
         ...
         description_content = "<div style='padding-left: 1em;'><h2>Description</h2><br><b>Item No:</b>{}<br><br>{}<br><br>{}<br><br>{}</div>".format(result['custom_product_code'],node_properties['description'], description_info, description_images)
