...
def user_defined_export(graph_mgr, node_id, node_properties):
     try:
         ...
         result['display'] = 'T'
         site_code = '0017'
         result['product_name'] = "["+node_properties['INFORMATION']['Brand :']+"] "+node_properties['name']
         ...
         if supplyPrice >= 2000000:
             ...
             final_price = retailPriceWithoutMargin + dollar2krw * amount * 0.1
