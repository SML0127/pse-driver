...
def user_defined_export(graph_mgr, node_id, node_properties):
     ...
     try:
         ...
         if node_properties['description'] is not None:
            ...
            for desc in str(translator.translate(node_properties['description'], dest="ko").text).split(". "):
               description_content += desc + ". <br style='margin-top:10pt'>"
