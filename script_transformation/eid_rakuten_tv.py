...
#             result['option_names'] = ['size']
         ...
         description_content = "<div style='padding-left: 1em;'><h2>Description</h2><br>{}<br>{}<br><br>{}</div>".format(node_properties['description2'],node_properties['description'],description_images)
