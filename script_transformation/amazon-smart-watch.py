...
#            idx = node_properties['p_name'].find(' ')  #dewalt brand name has a different form
#           if idx < 1:
#              node_properties['brand'] = ' '
#           else:
#              node_properties['brand'] = node_properties['p_name'][:idx-1]
         node_properties['brand'] = ''
...
#        weight = 5.0 
         ...
         shipping_price = node_properties["shipping_price"] # shipping price in amazon
         ...
         # 시계는 개별소비세와 교육세 필요 
         retailPriceWithoutMargin = (supplyPrice) * (1 + tariffRate)
