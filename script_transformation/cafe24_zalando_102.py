def user_defined_export(graph_mgr, node_id, node_properties):
    try:
        ...
        weight = node_properties['DictInfo'].get('Weight:', '2kg').lower()
        ...
        taxRate = 0.1 if amount * eur2krw >= 150 * dollar2krw else;
        margin_rate = 0.15;
        ...
        result['add_category_no'] = [{"category_no": 102, "recommend": "F", "new": "T"}]
