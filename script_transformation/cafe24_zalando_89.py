def user_defined_export(graph_mgr, node_id, node_properties):
    try:
        ...
        weight = node_properties['DictInfo'].get('Weight:', '1kg').lower()
        ...
        eur2usd = 1.1;
        dollar2krw = 1223;
        tariffRate = 0.08 if amount * eur2krw >= 150 * dollar2krw else 0;
        taxRate = 0.1 if amount * eur2krw >= 150 * dollar2krw else 0;
        margin_rate = 0.15;
        minimum_margin = 30000.0;
        lowest_price = -1;
        ...
        result['custom_product_code'] = node_properties['DictInfo']['Article number:']
        result['add_category_no'] = [{"category_no": 89, "recommend": "F", "new": "T"}]
