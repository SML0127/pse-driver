...
def user_defined_export(graph_mgr, node_id, node_properties):
     try:
         ...
         for idx, value in enumerate(node_properties['images']):
             print(idx)
             print(value)
             print(node_properties['images'][idx])
             if value[0] != 'h':
                 node_properties['images'][idx]  = 'https://www.ashford.com/' + value
         ...
         result['custom_product_code'] = node_properties['item_no'].split('UPC')[0]
