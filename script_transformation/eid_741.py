...
def user_defined_export(graph_mgr, node_id, node_properties):
     try:
         ...
         description_title = '<br><div><p style="text-align: center;font-size:14px">{}</p><br><br></div>'.format(result['product_name'])
         ...
         description_content = "<div style='padding-left: 1em; font-size:12px'><br>{}<br><br>{}</div>".format(node_properties['description'],description_images)
