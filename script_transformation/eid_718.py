...
def user_defined_export(graph_mgr, node_id, node_properties):
     ...
     try:
         ...
         if node_properties['description'] is not None:
            print('---------------------------------------------------')
            print(str(translator.translate(node_properties['description'], dest="ko").text))
            print('---------------------------------------------------')
            description_content = "<div style='padding-left: 1em;'><h2>Description</h2><br><br>{}<br><br>{}</div>".format(str(translator.translate(node_properties['description'], dest="ko").text),description_images)
         else:
            description_content = "<div style='padding-left: 1em;'><br>{}</div>".format(description_images)
