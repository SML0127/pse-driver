...
def user_defined_export(graph_mgr, node_id, node_properties):
     try:
         ...
         with open('delivery_charge_us.csv', 'r') as f:
         ...
         description_content = "<div style='padding-left: 1em;'><h2>Description</h2><br><br>i<b>ASIN:</b>{}<br><br>{}<br><br>{}</div>".format(result['custom_pro    duct_code'],node_properties['description'],description_images)
