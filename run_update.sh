...
for script in {1..2} 
do 
        echo 'python pse_driver.py --c update_to_mysite --job_id '$script' --groupbykey name description price spid'
        python pse_driver.py --c update_to_mysite --job_id $script --groupbykey name description price spid
	sleep 5
done;
